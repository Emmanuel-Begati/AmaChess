...
CREATE TABLE "puzzle_sessions" (
    ...
    CONSTRAINT "puzzle_sessions_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "user_stats" (
    ...
    "averageTimePerPuzzle" DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    "favoriteThemes" TEXT[],
...
-- AddForeignKey
ALTER TABLE "puzzle_sessions" ADD CONSTRAINT "puzzle_sessions_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
